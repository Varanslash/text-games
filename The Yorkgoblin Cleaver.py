...
def stat():
    ...
    print("EXP:", playerexp)
    print()
    print("Spell slots open:\nStall:", spellslot1, "\nFire Bolt:", spellslot2, "\nFull Heal:", spellslot3, "\nDisintegration:", spellslot4, "Magic Missile:", spellslot5, "Entrance:", spellslot6, "Ice Beam:", spellslot7, "Attract:", spellslot8)
...
def switch_spell():
    ...
    try:
        ...
        print("Invalid Spell!")
    print("What overworld spell slot would you like to use? (1 - 10)")
    try:
        userinput = int(input("Slot?"))
        currentowspellslot = userinput
        print("Current Spell Slot:", currentowspellslot)
    except ValueError:
        print("Invalid Spell!")
...
if True:
    ...
    spellslot7 = False
    spellslot8 = False
    spellslot9 = False # Not in use
    spellslot10 = False # Not in use
    spellslot11 = False # Not in use
    spellslot12 = False # Not in use
    spellslot13 = False # Not in use
    spellslot14 = False # Not in use
    spellslot15 = False # Not in use

    owspellslot1 = False # Not in use
    owspellslot2 = False # Not in use
    owspellslot3 = False # Not in use
    owspellslot4 = False # Not in use
    owspellslot5 = False # Not in use
    owspellslot6 = False # Not in use
    owspellslot7 = False # Not in use
    owspellslot8 = False # Not in use
    owspellslot9 = False # Not in use
    owspellslot10 = False # Not in use

    currentspellslot = 1
    currentowspellslot = 1
...
def dracula_boss():
    ...
    if miss == 10 or stallcountdown > 0:
        ...
        enemypower = (bosslevel * 6) + ((bosslevel) / 2) + round((draculacharisma) / 10)
        playerhp -= enemypower
        print(enemypower, "damage dealt!")
        turn = 1
        stallcountdown -= 1
...
def spell6_entrance():
    ...
    global playerhp
    if spellslot6 == True:
        d10 = random.choice(range(1, (charisma + 1)))
        if d10 < charisma:
            stallcountdown = 2
...
while True:
    ...
    # Abandoned Old House
        ...
        if dungeon3cell == 1:
            ...
            print("Old House. Cell 16. North, South.")
