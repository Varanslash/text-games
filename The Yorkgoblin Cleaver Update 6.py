    ...
    if monsterencounter == 10 or forcedencounter == 1:
        ...
        while not (enemyhp < 1):
            ...
            if enemyhp < 1:
                ...
                playergold += enemylevel * random.randint(1, 20)
...
def spells():
    # 1 - 18 are currently used, 11 spell slots are not filled in
    global currentspellslot
    global enemyhp
    global bosshp
    global playerpower
...
def spell5_magicmissile():
    ...
    global spellslot5
    if spellslot5 == True:
        # Choose a value 1..10 then scale by player level (Python-3-safe)
        playerpower = random.randint(1, 10) * playerlevel
    else:
        print("Spell failed!")
...
def manualsavedata():
    ...
    print()
    spellslot5 = True # Replace this print with setting your variables to the right values, do the same with bank and cell number
...
while True:
    ...
    # Courtyard
        ...
        if courtyard1cell == 1:
            ...
            print("Courtyard. Cell 4. North, East.")
            ...
            print("Courtyard. Cell 8. East, South, North.")
            monster = random.choice(["Gargoyle", "Knight"])
            userinput = input("Courtyard>")
            encounter()
            if userinput == "move east":
            ...
            print("Courtyard. Cell 9. East, South, West.")
            monster = random.choice(["Shade", "Gargoyle"])
            userinput = input("Courtyard>")
            encounter()
            if userinput == "move east":
            ...
            print("Courtyard. Cell 10. East, West, South.")
            monster = random.choice(["Knight", "Shade"])
            userinput = input("Courtyard>")
            encounter()
            if userinput == "move east":
            ...
            print("Courtyard. Cell 12. East, West, North.")
            monster = random.choice(["Knight", "Shade"])
            userinput = input("Courtyard>")
            encounter()
            if userinput == "move east":
            ...
            print("Courtyard. Cell 13. West, East.")
            ...
            print("Courtyard. Cell 14. East, North.")
            ...
            print("Courtyard. Cell 15. South, West.")
            monster = random.choice(["Knight", "Shade"])
            userinput = input("Courtyard>")
            encounter()
            if userinput == "move south":
        ...
        enemylevel = playerlevel * 0.9
        if odialobbycell == 1:
            print("Odia's Lobby. Cell 1. East, West.")
            monster = random.choice(["Gargoyle", "Knight", "Shade"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move east":
                bank = "courtyard1"
                courtyard1cell = 18
        ...
        elif odialobbycell == 2:
            print("Odia's Lobby. Cell 2. North, East, South.")
            monster = random.choice(["Obsidian Shade", "Void Attendant"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move north":
                odialobbycell = 7
        ...
        elif odialobbycell == 3:
            print("Odia's Lobby. Cell 3. North, West, South.")
            monster = random.choice(["Odia's Knight", "Glass Serpent"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move north":
                odialobbycell = 2
        ...
        elif odialobbycell == 4:
            print("Odia's Lobby. Cell 4. North, South.")
            monster = random.choice(["Void Crawler", "Obsidian Shade"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move north":
                odialobbycell = 3
        ...
        elif odialobbycell == 5:
            print("Odia's Lobby. Cell 5. North, West.")
            monster = random.choice(["Odia's Knight", "Glass Serpent"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move north":
        ...
        elif odialobbycell == 6:
            print("Odia's Lobby. Cell 6. East.")
            monster = random.choice(["Obsidian Shade", "Void Attendant"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move east":
        ...
        elif odialobbycell == 7:
            print("Odia's Lobby. Cell 7. West, South, North.")
            monster = random.choice(["Void Knight", "Obsidian Shade"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move west":
                odialobbycell = 11
        ...
        elif odialobbycell == 8:
            print("Odia's Lobby. Cell 8. South, North.")
            monster = random.choice(["Odia's Knight", "Void Crawler"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move south":
                odialobbycell = 7
        ...
        elif odialobbycell == 9:
            print("Odia's Lobby. Cell 9. South, West.")
            monster = random.choice(["Obsidian Shade", "Glass Serpent"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move south":
                odialobbycell = 8
        ...
        elif odialobbycell == 10:
            print("Odia's Lobby. Cell 10. East.")
            monster = random.choice(["Void Attendant", "Obsidian Shade"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move east":
                odialobbycell = 9
        ...
        elif odialobbycell == 11:
            print("Odia's Lobby. Cell 11. East, West.")
            monster = random.choice(["Shade", "Odia Knight"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move east":
                odialobbycell = 7
        ...
        elif odialobbycell == 12:
            print("Odia's Lobby. Cell 12. West, East.")
            monster = random.choice(["Void Crawler", "Obsidian Shade"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move west":
        ...
        elif odialobbycell == 13:
            print("Odia's Lobby. Cell 13. West, East.")
            monster = random.choice(["Void Knight", "Glass Serpent"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move west":
                odialobbycell = 19
        ...
        elif odialobbycell == 14:
            print("Odia's Lobby. Cell 14. West, East.")
            monster = random.choice(["Obsidian Shade", "Void Attendant"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move west":
        ...
        elif odialobbycell == 15:
            print("Odia's Lobby. Cell 15. South.")
            monster = random.choice(["Void Knight", "Obsidian Shade"])
            userinput = input("Odia's Lobby>")
            encounter()
            if userinput == "move south":
        ...
        elif odialobbycell == 16:
            print("Odia Lobby. Cell 16. South.")
            monster = random.choice(["Void Attendant", "Glass Serpent"])
            userinput = input("Odia Lobby>")
            encounter()
            if userinput == "move south":
                odialobbycell = 17
            elif userinput == "heal":
        ...
        elif odialobbycell == 17:
            print("Odia Lobby. Cell 17. South, West, East, North.")
            monster = random.choice(["Odia Knight", "Void Crawler"])
            userinput = input("Odia Lobby>")
            encounter()
            if userinput == "move south":
                odialobbycell = 18
        ...
        elif odialobbycell == 18:
            print("Odia Lobby. Cell 18. South.")
            monster = random.choice(["Obsidian Shade", "Void Attendant"])
            userinput = input("Odia Lobby>")
            encounter()
            if userinput == "move south":
        ...
        elif odialobbycell == 19:
            print("Odia Lobby. Cell 19. North, East, West.")
            monster = random.choice(["Void Knight", "Glass Serpent"])
            userinput = input("Odia Lobby>")
            encounter()
            if userinput == "move north":
        ...
        elif odialobbycell == 20:
            print("Odia Lobby. Cell 20. North, South.")
            monster = random.choice(["Void Attendant", "Obsidian Shade"])
            userinput = input("Odia Lobby>")
            encounter()
            if userinput == "move north":
        ...
        elif odialobbycell == 21:
            print("Odia Lobby. Cell 21. North.")
            monster = random.choice(["Void Crawler", "Shade"])
            userinput = input("Odia Lobby>")
            encounter()
            if userinput == "move north":
                odialobbycell = 20
        ...
        elif odialobbycell == 22:
            print("Odia Lobby. Cell 22. East.")
            monster = random.choice(["Void Knight", "Glass Serpent"])
            userinput = input("Odia Lobby>")
            encounter()
            if userinput == "move east":
        ...
        elif odialobbycell == 23:
            print("Odia Lobby. Cell 23. East.")
            monster = random.choice(["Obsidian Shade", "Void Attendant"])
            userinput = input("Odia Lobby>")
            encounter()
            if userinput == "move east":
        ...
        elif odialobbycell == 24:
            print("Odia Lobby. Cell 24. North.")
            monster = random.choice(["Void Crawler", "Odia Knight"])
            userinput = input("Odia Lobby>")
            encounter()
            if userinput == "move north":
                odialobbycell = 23
        ...
        elif odialobbycell == 25:
            print("Odia Lobby. Cell 25. East, West.")
            monster = random.choice(["Void Attendant", "Obsidian Shade"])
            userinput = input("Odia Lobby>")
            encounter()
            if userinput == "move east":
